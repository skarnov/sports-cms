                            ...
                            <div class="product-container product-block">
                                <div class="left-block">
                                    <h5 itemprop="name" class="name">
                                        <a class="product-name" href="<?php echo base_url(); ?>evis_store/product_details/<?php echo $v_latest_product->product_id; ?>" alt="<?php echo $v_latest_product->product_name; ?>" title="<?php echo $v_latest_product->product_name; ?>" itemprop="url">
                                    ...
                                    <div class='block-code'>
                                        ...
                                        <div class="product-image-container">
                                            <a class="product_img_link" href="<?php echo base_url(); ?>evis_store/product_details/<?php echo $v_latest_product->product_id; ?>" alt="<?php echo $v_latest_product->product_name; ?>" title="<?php echo $v_latest_product->product_name; ?>" itemprop="url">
                                            ...
                                            <?php
                                            $product_tag = $v_latest_product->product_tag;
                                            if ($product_tag != NULL) {
                                                ?>
                                                <a class="sale-box">
